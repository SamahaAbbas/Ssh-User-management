...
````
bash <(curl -Ls https://raw.githubusercontent.com/SamahaAbbas/Ssh-User-management/master/install.sh --ipv4)
````
...
````
bash <(curl -Ls https://raw.githubusercontent.com/SamahaAbbas/Ssh-User-management/master/ssl.sh --ipv4)
````
